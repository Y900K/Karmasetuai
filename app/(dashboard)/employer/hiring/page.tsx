...
type Application = { id: string; status: Stage; match_score: number; created_at: string; student_id: string; job_posts: { id: string; title: string; required_trade: string }; profiles?: { full_name?: string } };
